...
def main():
    ...
    print("Tare automatique (pas de poids sur la balance)")
    hx.tare(times=10)
    
    # Étape 2 : Demander à l’utilisateur de poser un poids
    print("Pose un poids de 1 kg sur la balance dans les 5 secondes...")
    for i in range(5, 0, -1):
        print(f"{i}...")
        time.sleep(1)
    
    # Étape 3 : Calibration avec le poids posé
    hx.calibrate(known_weight_kg=1.0, times=10)
    
    print("Calibration terminée. Démarrage des mesures.")
